export const projects = [
  {
    title: 'New2morrow blog',
    description: "This is a full stack projects thats built with Next.js and tailwindcss and uses GraphQl to fetch and post data from graphCMS ,from a back-end I created. ",
      image: '/images/new/blog.png',
      tags: ['Next.js', 'tailwindcss' , 'scss', 'graphql', 'graphcms'],
    source: 'https://github.com/Antonio94709/blog-nextjs-app/tree/main',
    visit: 'https://blog-nextjs-app-five.vercel.app/',
    id: 0,
  },
  {
    title: 'Spotify clone',
    ...
    visit: 'https://spotify-3-alpha.vercel.app/login',
    id: 1,
  },
  {
    ...
    visit: 'https://facebook-nextjs-seven.vercel.app/',
    id: 2,
  },
  {
    title: 'hulu',
    description: "A simple responsive clone that fetches data from a movie API. You can browse through different categories and movies related to that category will be displayed.",
    image: '/images/new/hulu.png',
    tags: ['Next.js', 'tailwindcss', 'Movie API'],
    source: 'https://github.com/Antonio94709/hulu/tree/main',
...
export const TimeLineData = [
  ...
  { year: 2020, text: 'Started learning more about development', },
  { year: 2021, text: 'Began to practice and got my first job', },
  { year: 2022, text: 'Started my journey to full-stack', },
